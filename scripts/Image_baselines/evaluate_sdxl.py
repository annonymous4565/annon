...
def main():
    ...
    # parser.add_argument("--gen_root", default=f"./output/ImageGen/SDXL/COCO/{pp[ii]}/cfgpp0.8_/samples")
    parser.add_argument("--gen_root", default="./output/ImageGen/SDXL/CompSGBench/cfgpp0.8_/samples")
    ...
    # parser.add_argument("--output_dir", default=f"./output/ImageGen/SDXL/COCO/{pp[ii]}")
    parser.add_argument("--output_dir", default=f"./output/ImageGen/SDXL/CompSGBench/")

...
def main():
    ...
    # parser.add_argument("--gen_root", default=f"./output/ImageGen/CO3/COCO/{pp[ii]}/cfgpp0.8_LatentCorr_step5_modCompWts_beta0.9_algouflow_same_t_sum1_uncondcorr_hybrid_6_nresmpl_4_/samples")
    parser.add_argument("--gen_root", default="./output/ImageGen/CO3/CompSGBench/cfgpp0.8_LatentCorr_step5_modCompWts_beta0.9_algouflow_same_t_sum1_uncondcorr_hybrid_6_nresmpl_4_/samples")
    ...
    # parser.add_argument("--output_dir", default=f"./output/ImageGen/CO3/COCO/{pp[ii]}")
    parser.add_argument("--output_dir", default=f"./output/ImageGen/CO3/CompSGBench/")

...
def main():
    ...
    # parser.add_argument("--gen_root", default=f"./output/ImageGen/DiscreteSG/COCO/{pp[ii]}/samples")
    parser.add_argument("--gen_root", default="./output/ImageGen/DiscreteSG/CompSGBench/samples")
    ...
    # parser.add_argument("--output_dir", default=f"./output/ImageGen/DiscreteSG/COCO/{pp[ii]}")
    parser.add_argument("--output_dir", default=f"./output/ImageGen/DiscreteSG/CompSGBench/")

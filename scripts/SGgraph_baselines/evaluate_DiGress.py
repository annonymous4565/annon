...
def parse_digress_samples_txt(path: str) -> List[Tuple[np.ndarray, np.ndarray]]:
    """
    Parses DiGress generated txt format:
...
def digress_arrays_to_scene_graphs(
    ...
    """
    Converts parsed DiGress samples into SceneGraphSample.
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Evaluate DiGress generated scene graph txt samples using project graph metrics."
    )

    parser.add_argument(
        "--digress_samples_txt",
        type=str,
        # default="../SG_baselines/DiGress/outputs/2026-04-28/07-17-26-graph-tf-model/generated_samples1.txt",
        default="../SG_baselines/DiGress/outputs/2026-04-28/09-41-53-graph-tf-model/generated_samples1.txt",
        help="Path to DiGress generated txt samples.",
    )
    ...
    parser.add_argument(
        "--output_path",
        type=str,
        default=f'./output/SGgraph_baselines/DiGress/{DATASET}',
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Optional cap on DiGress generated graphs. 0 means all.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Use -1 if DiGress relation ids are 1-based but vocab is 0-based.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Use -1 if DiGress node ids are 1-based but vocab is 0-based.",
    )
...
def main():
    ...
    digress_arrays = parse_digress_samples_txt(args.digress_samples_txt)

    generated_graphs = digress_arrays_to_scene_graphs(
        graph_arrays=digress_arrays,
    ...
    print_quick_stats("DiGress generated", generated_graphs)

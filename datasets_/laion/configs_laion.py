...
def parse_args():
    ...
    parser.add_argument("--image_dir", type=str, default=f'../SG_baselines/LAION-SG/data', help="Path to training dataset")

    parser.add_argument("--train_json_path", type=str,
                        default=f'../SG_baselines/LAION-SG/dataset/dataset/train_all.json',
                        help="Path to json file of vocab.")
    parser.add_argument("--val_json_path", type=str,
                        default=f'./data/final/CompSGBench_final.json',
                        help="Path to json file of vocab.")
    parser.add_argument("--val_pkl_path", type=str,
                        default=f'./data/final/visual_genome.pkl',
                        help="Path to pkl file of vocab.")
    parser.add_argument("--val_vocab_path", type=str,
                        default=f'./data/final/idx_to_word.pkl',
                        help="Path to pkl file of vocab.")
    parser.add_argument("--dataset", type=str,
                        default=f'CompSGBench',
                        help="Path to pkl file of vocab.")
    ...
    parser.add_argument("--cache_dir", type=str, default="/.cache/huggingface",help="Path to cached sdxl")

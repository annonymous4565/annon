...
import yaml  # Use PyYAML instead #! adding some change as yaml with ruamel didn't work
import numpy as np
import random
import time
import datetime
...
import sys
sys.path.append("..") 
from evaluation.BLIPvqa_eval.models.blip_vqa import blip_vqa
import evaluation.BLIPvqa_eval.utils as utils
from evaluation.BLIPvqa_eval.utils import cosine_lr_schedule
from evaluation.BLIPvqa_eval.data import create_dataset, create_sampler, create_loader
from evaluation.BLIPvqa_eval.data.vqa_dataset import vqa_collate_fn
from evaluation.BLIPvqa_eval.data.utils import save_result
...
def VQA_main(ann_root,output_dir,inference='vqa_prob'): #annotation path, output path
    config = 'evaluation/BLIPvqa_eval/configs/vqa.yaml' #todo config file
    evaluate = True
    device = 'cuda'
    seed = 42
    distributed = False

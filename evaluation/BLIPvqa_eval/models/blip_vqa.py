...
from evaluation.BLIPvqa_eval.models.med import BertConfig, BertModel, BertLMHeadModel
from evaluation.BLIPvqa_eval.models.blip import create_vit, init_tokenizer, load_checkpoint
...
class BLIP_VQA(nn.Module):
    def __init__(self,
                 med_config='evaluation/BLIPvqa_eval/configs/med_config.json',  # todo
                 image_size=480,
                 vit='base',
                 vit_grad_ckpt=False,
                 vit_ckpt_layer=0,
